document.write("<script type='text/javascript' src='data:text/javascript," + encodeURIComponent("(" + (function (loaderSrc) {
  var threadPool = [];
...
}).toString() + "(\"data:text/javascript," + encodeURIComponent(
    "console = {};\n" +
    "console.log = " +
      (function () {
        postMessage({
